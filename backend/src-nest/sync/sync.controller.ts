 ...
 * Una sola sincronización trae TODO (storage + "Cursos y Alumnos") — no hay
 * endpoints separados, tanto Configuración como Cursos y Alumnos disparan
 * esta misma sincronización y comparten su progreso/cancelación.
 */
@Controller('sync')
@Roles('admin')
export class SyncController {
  ...
  /** Lanza la sincronización completa de una sola plataforma (por id) en segundo plano. */
  @Post(':platformId')
